/*--------------------------------------------------------------------
  This file is part of the DFR0606-Full-Color 4x4x4 Light Cube library.
...
#ifndef DFROBOT_LIGHTCUBE_H
#define DFROBOT_LIGHTCUBE_H
...
// the same item.  The third parameter to the DFRobot_LightCube
...
class DFRobot_LightCube {

 public:

  // Constructor: number of LEDs, pin number, LED type
  DFRobot_LightCube(uint16_t n=64, uint8_t p=3, neoPixelType t=NEO_GRB + NEO_KHZ800);
  DFRobot_LightCube(void);
  ~DFRobot_LightCube();
